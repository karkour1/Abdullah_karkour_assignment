...
#define GPIO_PIN_0                 ((uint8)0x00)  /* Pin 0 selected    */
#define GPIO_PIN_1                 ((uint8)0x01)  /* Pin 1 selected    */
#define GPIO_PIN_2                 ((uint8)0x02)  /* Pin 2 selected    */
#define GPIO_PIN_3                 ((uint8)0x03)  /* Pin 3 selected    */
#define GPIO_PIN_4                 ((uint8)0x04)  /* Pin 4 selected    */
#define GPIO_PIN_5                 ((uint8)0x05)  /* Pin 5 selected    */
#define GPIO_PIN_6                 ((uint8)0x06)  /* Pin 6 selected    */
#define GPIO_PIN_7                 ((uint8)0x07)  /* Pin 7 selected    */
#define GPIO_PIN_8                 ((uint8)0x08)  /* Pin 8 selected    */
#define GPIO_PIN_9                 ((uint8)0x09)  /* Pin 9 selected    */
#define GPIO_PIN_10                ((uint8)0x0A)  /* Pin 10 selected   */
#define GPIO_PIN_11                ((uint8)0x0B)  /* Pin 11 selected   */
#define GPIO_PIN_12                ((uint8)0x0C)  /* Pin 12 selected   */
#define GPIO_PIN_13                ((uint8)0x0D)  /* Pin 13 selected   */
#define GPIO_PIN_14                ((uint8)0x0E)  /* Pin 14 selected   */
#define GPIO_PIN_15                ((uint8)0x0F)  /* Pin 15 selected   */
